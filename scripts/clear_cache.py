...
Exemples d'utilisation (dans l'hôte):
  docker exec -it powerclasss_app python scripts/clear_cache.py --all
  docker exec -it powerclasss_app python scripts/clear_cache.py --prefix migration_logs:
  docker exec -it powerclasss_app python scripts/clear_cache.py --clients-reminders
  docker exec -it powerclasss_app python scripts/clear_cache.py --expired-only
  docker exec -it powerclasss_app python scripts/clear_cache.py --prefix stats: --dry-run
